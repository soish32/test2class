...
public class LoginDto implements Serializable {
			private static final long serialVersionUID =5772106319941122326L;
			private int seq;
			private String id;
			private String name;
		...
		public String toString() {
			return "LoginDto [seq=" + seq + ", id=" + id + ", name=" + name + ", password=" + password
					+ ", address=" + address + ", phone=" + phone + ", email=" + email + ", enabled=" + enabled
